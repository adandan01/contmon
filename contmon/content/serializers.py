...
class CreditCardOfferDetailSerializer(serializers.ModelSerializer):
...
class CreditCardOfferListSerializer(serializers.ModelSerializer):
    review_state_display = serializers.SerializerMethodField()
    ...
    class Meta:
        model = CreditCardOffer
        fields = ('id', 'name', 'domain', 'image', 'review_state', 'review_state_display')
